...
import { Hammer, Phone, MessageCircle, Star, Users, Clock, Award } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-antique">
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-8">
            Premium custom furniture and carpentry services with 15+ years of expertise
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-white text-white hover:bg-white hover:text-black px-8 py-4 text-lg transition-all duration-300 hover:scale-105"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 fade-in-up">
            <h2 className="font-bold text-4xl text-brown-primary mb-4">Our Signature Collections</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From elegant beds to custom TV units, we create furniture that transforms your space
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="group cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 scale-in">
              ...
              <CardContent className="p-6">
                <h3 className="font-semibold text-xl text-brown-primary mb-2 group-hover:text-brown-secondary transition-colors duration-300">Custom Beds</h3>
                <p className="text-gray-600 mb-2 font-bold text-lg">Starting from ₹25,000</p>
                <p className="text-sm text-gray-500">King, Queen, Single sizes available</p>
              </CardContent>
            </Card>
            ...
            <Card className="group cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 scale-in">
              <div 
                className="h-64 bg-cover bg-center rounded-t-lg group-hover:scale-110 transition-transform duration-300"
                style={{
                  backgroundImage: "url('https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600')"
                }}
              />
              <CardContent className="p-6">
                <h3 className="font-semibold text-xl text-brown-primary mb-2 group-hover:text-brown-secondary transition-colors duration-300">Designer Chairs</h3>
                <p className="text-gray-600 mb-2 font-bold text-lg">Starting from ₹8,000</p>
                <p className="text-sm text-gray-500">Dining, Office, Accent chairs</p>
              </CardContent>
            </Card>
            ...
            <Card className="group cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 scale-in">
              ...
              />
              <CardContent className="p-6">
                <h3 className="font-semibold text-xl text-brown-primary mb-2 group-hover:text-brown-secondary transition-colors duration-300">TV Units</h3>
                <p className="text-gray-600 mb-2 font-bold text-lg">Starting from ₹15,000</p>
                <p className="text-sm text-gray-500">Wall-mounted, Floor standing</p>
              </CardContent>
            </Card>
            ...
            <Card className="group cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 scale-in">
              ...
              />
              <CardContent className="p-6">
                <h3 className="font-semibold text-xl text-brown-primary mb-2 group-hover:text-brown-secondary transition-colors duration-300">Custom Pieces</h3>
                <p className="text-gray-600 mb-2 font-bold text-lg">Price on request</p>
      ...
      <section id="gallery" className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 fade-in-up">
            <h2 className="font-bold text-4xl text-brown-primary mb-4">Our Masterpieces</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredProjects?.slice(0, 6).map((project, index) => (
              <Card key={project.id} className={`group cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 ${
                index % 3 === 0 ? 'fade-in-left' : index % 3 === 1 ? 'fade-in-up' : 'fade-in-right'
              }`}>
                <div 
                ...
                <CardContent className="p-4">
                  <h3 className="font-semibold text-lg text-brown-primary group-hover:text-brown-secondary transition-colors duration-300">{project.title}</h3>
                  <p className="text-gray-600">{project.description}</p>
                  {project.category && (
                    <Badge variant="secondary" className="mt-2 group-hover:bg-brown-primary group-hover:text-white transition-colors duration-300">
                      {project.category}
                    </Badge>
                  )}
                </CardContent>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in-left">
              <h2 className="font-bold text-4xl text-brown-primary mb-6">Our Story</h2>
              <p className="text-lg text-gray-700 mb-6">
                With over 15 years of experience in fine carpentry and furniture making, CraftWood has been 
                transforming homes across the region. We specialize in creating bespoke furniture pieces that 
                combine traditional craftsmanship with modern design sensibilities.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                Our team of skilled artisans takes pride in every piece we create, ensuring that each item is 
                not just functional but also a work of art that reflects your personal style and enhances your living space.
              </p>
      ...
      <section id="contact" className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 fade-in-up">
            <h2 className="font-bold text-4xl text-brown-primary mb-4">Get In Touch</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ready to bring your furniture vision to life? Contact us today for a free consultation
            </p>
          </div>
          ...
          <div className="mt-12 text-center space-y-4 scale-in">
            <Button asChild size="lg" className="bg-brown-primary hover:bg-brown-secondary transition-all duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <div className="mx-4">
              <Button asChild size="lg" className="bg-green-500 hover:bg-green-600 transition-all duration-300 hover:scale-105 hover:shadow-lg">
                <a 
